...
function handleNewPage() {
    return new Promise(async (resolve, reject) => {
        ...
        page.on('console', (message) => this.data.emit(`pageMessage`, {messageType: message.type().toLowerCase(), message: message.text()}))
        page.on('pageerror', message => this.data.emit(`pageError`,  {message: message.message}))
